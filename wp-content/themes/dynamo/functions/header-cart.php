...
<a class="header-cart-button" href="#"><?php _e("Shopping Bag", "ocmx"); ?> <?php echo sprintf(_n('(%d)', '(%d)', $woocommerce->cart->cart_contents_count), $woocommerce->cart->cart_contents_count); ?></a>
