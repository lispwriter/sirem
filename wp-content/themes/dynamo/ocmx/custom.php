...
function ocmx_add_custom_meta(){
	global $obox_meta, $services_meta, $features_meta, $partners_meta, $features_category, $testimonials_meta, $team_meta, $portfolio_meta, $slider_meta, $layout, $portfolio_excerpt, $maps, $order;
	$obox_meta = array(
		"media" => array (
			"name"		=> "other_media",
			"default"	=> "",
	...
	$layout = array(
		...
		"title-display" => array (
			...
			"input_type"	=> "select",
			"options" 	=> array("Title" => "title", "Slider" => "slider")
		)
	);
...
add_action( 'init', 'ocmx_add_custom_meta' );
