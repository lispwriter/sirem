						...
						<?php if($posttype != 'partners') : ?>
							<div class="content">
								...
								if(isset( $show_excerpts ) && $show_excerpts == "on" ) :
									...
									<?php /* inserting the date on lastest blog post widget only */ ?>
									<?php if($posttype == "post"): ?>
									<div class="time"><?php echo the_time(get_option('date_format')); ?></div>
									<?php endif; ?>
									<h4 class="post-title"><a href="<?php echo $link; ?>"><?php the_title(); ?></a></h4>
									<div class="copy">  
								...
								<?php endif;
								 ...
								 if(isset($read_more) && $read_more == "on") :
									echo '<a href="'.$link.'" class="read-more">'.__('Learn More', 'ocmx').'</a>';
								endif; ?>
							<?php endif; ?>
							</div>
						<?php endif; ?>
