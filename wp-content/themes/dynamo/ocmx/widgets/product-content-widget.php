		...
		<li class="content-widget product-content-widget widget clearfix">
			...
			<ul class="<?php echo $layout_columns; ?>-column content-widget-item products clearfix">
				...
				<?php while ( $loop->have_posts() ) : $loop->the_post();
					...
					$image_args  = array('postid' => $post->ID, 'width' => $width, 'height' => $height, 'hide_href' => true, 'exclude_video' => true, 'wrap' => 'div', 'wrap_class' => 'post-image fitvid', 'imglink' => false, 'resizer' => $resizer);
