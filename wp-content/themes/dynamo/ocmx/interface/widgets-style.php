...
div.widget[id*=_obox_content_] .widget-top, div.widget[id*=_obox_category_widget] .widget-top, div.widget[id*=_obox_product_content_] .widget-top, div.widget[id*=_obox_features_widget] .widget-top, div.widget[id*=_obox_partners_] .widget-top{
	color: #fff;
	text-shadow: 1px 1px rgba(0,0,0,0.4);
